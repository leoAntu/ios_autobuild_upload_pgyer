...
#假设脚本放置在与项目相同的路径下
project_path="$(dirname "$(pwd)")/CashLoan_NEW"
#取当前时间字符串添加到文件结尾
...
#指定项目地址
workspace_path="$project_path/CashLoan.xcworkspace"
#指定输出路径
output_path="/Users/dingdongqianbaofuyin/Desktop"
#指定输出归档文件地址
archive_path="$output_path/CashLoan_${now}.xcarchive"
#指定输出ipa地址
ipa_path="$output_path/CashLoan_${now}.ipa"
#指定输出ipa名称
ipa_name="CashLoan_${now}.ipa"
